...
# THESE STRAINS HAD URL ISSUES IN THE DATA SCRAPE, SO I MANUALLY ADDED THE CORRECT LINKS
# TO THE START OF THE STRAINS LIST CSV

# fail strain: blue-automazar                 blue-auto-mazar
# fail strain: bruce-banner-bx-2              bruce-banner-bx-20
# fail strain: buddha-s-sister                buddhas-sister
# fail strain: cbd-auto-charlotte-s-angel
# fail strain: cbd-charlotte-s-angel
# fail strain: charlotte-s-web                charlottes-web
# fail strain: chem-dawg                      chemdawg
# fail strain: cotton-candy-kush              cotton-candy
# fail strain: crocketts-dawg                 crockett-s-dawg
# fail strain: crocketts-tangie               crockett-s-tangie
# fail strain: dr-greenthumb-s-em-dog         dr-greenthumbs-em-dog
# fail strain: freddy-s-best                  freddys-best
# fail strain: green-crack-punch              green-punch
